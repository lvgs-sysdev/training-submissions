    ...
    <form action={handleSubmit} className="flex flex-col gap-10">
      <div className="flex flex-row gap-2">
        ...
        <div className="flex flex-col gap-2">
          <Input type="text" id="userName" name="userName" defaultValue={account.user_name} maxLength={MAX_LENGTH_OF_USER_NAME} className="w-auto" required />
      ...
      <div className="flex flex-row gap-2">
        ...
        <div className="flex flex-col gap-2">
          <Input type="email" id="email" name="email" placeholder=" " defaultValue={account.email} className="w-auto peer" required />
      ...
      <div className="flex self-end gap-6">
        <Button onClick={onCancelButtonClick} variant="outline" className="max-w-20 w-20">Cancel</Button>
        <Button type="submit" className="max-w-20 w-20">Save</Button>
      </div>
    </form>
  )
}

async function fetchDetail() {
    ...
    try{
        const response = await fetch(`http://localhost:3000/article-detail/${articleId}`);
        ...
        document.getElementById('detail_date').innerText = new Date(article.updated_at).toLocaleDateString();
